...
<c:forEach var="book" items="${requestScope.lastlyBook }">
	<li>
		<a class="pic1" href="${pageContext.request.contextPath }/book_searchById.do?bid=${book.bid }"><img src="/spring_bookshop/upload/book/images/${book.image }"  title="${book.bname }" width="54px" height="54px"/></a>
   	...
   	<div class="detail">
        ...
        <ul class="book_ul">
	    	<c:forEach var="book" items="${requestScope.bestSellerBooks }" begin="0" end="5">
	        	<li>
	            	<div class="pic"><a href="${pageContext.request.contextPath }/book_searchById.do?bid=${book.bid }"><img src="/spring_bookshop/upload/book/images/${book.image }"  title="${book.bname }" width="120px" height="120px"/></a></div>
