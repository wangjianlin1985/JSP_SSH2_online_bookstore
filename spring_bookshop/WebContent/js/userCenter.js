...
function changeNickname(){
	...
	$.post('/spring_bookshop/user_changeNickname.do',{nickname:nickname,uid:uid},function(data){
		if(data==0){
			alert("更新成功");
...
function changePassword(){
	...
	$.post('/spring_bookshop/user_changePassword.do',{password:password,uid:uid,npassword:npassword},function(data){
		if(data==0){
			alert("更新成功");
			window.location.reload();
		}
