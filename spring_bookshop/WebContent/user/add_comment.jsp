...
<tr class="card_tr">
	<td width="200px"><a href="/spring_bookshop/book_searchById.do?bid=${bookDetail.bid }" class="bookPic"><img src="/spring_bookshop/upload/book/images/${bookDetail.image }"  width="56px" height="56px"/></a></td>
	<td width="395px"><a href="/spring_bookshop/book_searchById.do?bid=${bookDetail.bid }">${bookDetail.bname }</a></td>
	<td width="224px"><span class="d_price">¥${bookDetail.price }</span></td>
	<td width="141px">无</td>
</tr>
</table>
<div class="shoppingcart_total" id="div_total" style="">
<form action="/spring_bookshop/addComment.do" method="post" id="commentForm">
