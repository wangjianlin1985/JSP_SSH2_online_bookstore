...
<div class="box">
    ...
    <!-- Table -->
    <div class="table">
    	<form action="/spring_bookshop/deleteNotice.do" method="post" name="showForm" id="showForm">
        ...
        <s:iterator var="notice" value="#request.notices">
            <tr>
                ...
                <td>${notice.nTime }</td>
                <td><a href="javascript:void(0);" onclick="javascript:if(confirm('确定删除该公告吗？')){location='/spring_bookshop/deleteNotice.do?item=${notice.nid }';};">
