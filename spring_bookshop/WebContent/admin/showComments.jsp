...
<div class="box">
    ...
    <!-- Table -->
    <div class="table">
    	<form action="/spring_bookshop/deleteComment.do" method="post" name="showForm" id="showForm">
        ...
        <s:iterator var="comment" value="#request.comments">
            <tr>
                ...
                <td><a href="javascript:void(0);" onclick="javascript:if(confirm('确定删除该评论吗？')){location='/spring_bookshop/deleteComment.do?item=${comment.cid }';};">
