...
<div class="box">
    ...
    <!-- Table -->
    <div class="table">
    	<form action="/spring_bookshop/user_lock.do" method="post" name="showForm" id="showForm">
        ...
        <s:iterator var="user" value="#request.users">
            <tr>
	            ...
	            <c:if test="${user.status==0 }">
	                <td><a href="javascript:void(0);" onclick="javascript:if(confirm('确定锁定该用户吗？')){location='/spring_bookshop/user_lock.do?item=${user.uid }';};">
	                <span class="editSpan"></span></a></td>
                </c:if>
	            <c:if test="${user.status==1 }">
	                <td><a href="javascript:void(0);" onclick="javascript:if(confirm('确定解锁该用户吗？')){location='/spring_bookshop/user_unlock.do?item=${user.uid }';};">
	                <span class="editSpan"></span></a></td>
                </c:if>
            </tr>
         </s:iterator>   
